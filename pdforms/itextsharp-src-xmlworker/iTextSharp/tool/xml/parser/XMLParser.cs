...
namespace iTextSharp.tool.xml.parser {
    ...
    public class XMLParser {
        ...
        virtual public void Parse(StringReader reader)
        {
            TextReader txtReader = reader;
            ParseWithReader(txtReader);
        }
        virtual public void Parse(string reader)
        {
            TextReader txtReader = new StringReader(reader);
            ParseWithReader(txtReader);
        }
