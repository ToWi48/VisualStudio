...
namespace iTextSharp.tool.xml {
    ...
    public class XMLWorkerHelper {
        ...
        virtual public void ParseXHtml(PdfWriter writer, Document doc, System.IO.StringReader inp)
        {
            CssFilesImpl cssFiles = new CssFilesImpl();
            cssFiles.Add(GetDefaultCSS());
            StyleAttrCSSResolver cssResolver = new StyleAttrCSSResolver(cssFiles);
        ...
        virtual public void ParseXHtml(PdfWriter writer, Document doc, string inp)
        {
            CssFilesImpl cssFiles = new CssFilesImpl();
            cssFiles.Add(GetDefaultCSS());
            StyleAttrCSSResolver cssResolver = new StyleAttrCSSResolver(cssFiles);
