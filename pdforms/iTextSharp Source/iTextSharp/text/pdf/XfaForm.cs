    ...
    public class XfaForm {
        ...
        */
        virtual public String FindFieldName(String name, AcroFields af)
        {
            ...
            if (acroFieldsSom.InverseSearchGlobal(Xml2Som.SplitParts(name)) == null) {
                if (name.Contains(".value")) { 
                    string lstName = name.Substring(0, name.LastIndexOf("."));
                    return acroFieldsSom.InverseSearchGlobal(Xml2Som.SplitParts(lstName));
                }
            }
