...
namespace iTextSharp.text.pdf {
    ...
    */
    public class PdfReader : IPdfViewerPreferences, IDisposable, System.ICloneable
    {
        ...
        {
            {
                ...
                //        {
                //            try {
                //                clone.GetType().GetProperty(p.Name).SetValue(clone, p.GetValue(this, null), null);
                //            }catch(Exception exClone){
                //                string msg = exClone.Message;
                //            }
                //        }
                //    }
                //}
