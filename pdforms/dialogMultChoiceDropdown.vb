...
Public Class dialogMultChoiceDropdown
    ''' <summary>
    ...
    Public Sub loadCombobox(strValues() As String)
        Try
            ...
            If strValues.Length > 0 Then
                For i As Integer = 0 To strValues.Length - 1
                    ComboBox1.Items.Add(CStr(strValues(i).ToString() & ""))
                Next
                values.AddRange(strValues)
                names.AddRange(strValues)
            End If
        Catch ex As Exception
            Err.Clear()
        End Try
    End Sub
    Public Sub loadCombobox(strValues() As String, Optional strNames() As String = Nothing)
        Try
            ComboBox1.Items.Clear()
            values = New List(Of String)
            names = New List(Of String)
            If strValues.Length > 0 Then
                ...
                Next
                values.AddRange(strValues)
                If Not strNames Is Nothing Then
                    If strNames.Length > 0 Then
                        names.AddRange(strNames)
                    End If
                End If
            End If
        Catch ex As Exception
        ...
        End Try
    End Sub
    Public Function comboBoxSelectIndex() As Integer
        Try
        ...
        Return -1
    End Function
    Public Function comboBoxSelectedName() As String
        Try
            If comboBoxSelectIndex() >= 0 Then
                Return names(comboBoxSelectIndex) & ""
            End If
        Catch ex As Exception
            Err.Clear()
        End Try
        Return ""
    End Function
    Public Function comboBoxSelectedValue() As String
        Try
            If comboBoxSelectIndex() >= 0 Then
                Return values(comboBoxSelectIndex) & ""
            End If
        Catch ex As Exception
            Err.Clear()
        End Try
