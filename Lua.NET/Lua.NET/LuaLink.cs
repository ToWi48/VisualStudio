...
;
	...
	[UnmanagedFunctionPointer(Settings.CConv, CharSet = Settings.CSet)]
	public delegate IntPtr lua_Reader(lua_StatePtr State, IntPtr UD, IntPtr Size);
...
(L, I);
		...
		// EDIT TOM 21.05.21
		[DllImport(Settings.DllName, CharSet = Settings.CSet, CallingConvention = Settings.CConv)]
		public static extern int luaL_loadstringpath(lua_StatePtr L, string S, string Path);
		// EDIT END
